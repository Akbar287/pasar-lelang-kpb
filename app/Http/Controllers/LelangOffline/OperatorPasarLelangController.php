...
class OperatorPasarLelangController extends Controller
{
    ...
    public function store(OperatorPasarLelangRequest $operatorPasarLelangRequest)
    {
        ...
        $operator = $offlineProfile->operator_pasar_lelang()->create($this->operatorPasarLelang(true));
    ...
    {
        $operator->update($this->operatorPasarLelang(false));
    ...
    public function operatorPasarLelang($cek)
    {
        return $cek ? [
