...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('kontrak', function (Blueprint $table) {
            ...
            $table->string('simbol', 32);
            $table->decimal('minimum_transaksi', 18, 2);
            $table->decimal('maksimum_transaksi', 18, 2);
            $table->decimal('fluktuasi_harga_harian', 18, 2);
            $table->decimal('premium', 18, 2);
            $table->decimal('diskon', 18, 2);
            $table->decimal('jatuh_tempo_t_plus', 18, 2);
