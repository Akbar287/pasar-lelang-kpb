                        ...
                        <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                            <div class="card card-primary">
                                ...
                                <div class="card-footer">
                                    @if($lelang->status_lelang_pivot()->join('status_lelang', 'status_lelang.status_lelang_id', 'status_lelang_pivot.status_lelang_id')->where('status_lelang.nama_status', ['Selesai', 'Transaksi Lelang', 'Verifikasi Transaksi', 'Transaksi Selesai', 'Verifikasi Transaksi Ditolak'])->count() > 0)
                                    <a href="{{ route('online.list.lelang_sesi', [$masterSesiLelang->master_sesi_lelang_id, $lelangSesiOnline->lelang_sesi_online_id, $lelang->lelang_id]) }}" class="btn btn-danger btn-block"><i class="fas fa-times"></i> Ditutup</a>
                                    @elseif($lelang->status_lelang_pivot()->join('status_lelang', 'status_lelang.status_lelang_id', 'status_lelang_pivot.status_lelang_id')->where('status_lelang.nama_status', 'Aktif')->count() > 0)
                                        @if($lelang->peserta_lelang_aktif()->where('master_sesi_lelang_id', $masterSesiLelang->master_sesi_lelang_id)->where('lelang_sesi_online_id', $lelangSesiOnline->lelang_sesi_online_id)->count() > 0)

                                        @if($lelang->peserta_lelang_aktif()->where('master_sesi_lelang_id', $masterSesiLelang->master_sesi_lelang_id)->where('lelang_sesi_online_id', $lelangSesiOnline->lelang_sesi_online_id)->first()->aktif)
                                        <a href="{{ route('online.list.lelang_sesi', [$masterSesiLelang->master_sesi_lelang_id, $lelangSesiOnline->lelang_sesi_online_id, $lelang->lelang_id]) }}" class="btn btn-primary btn-block"><i class="fas fa-clock"></i> Masuk</a>
                                        @else
                                        <a href="{{ route('online.list.lelang_sesi', [$masterSesiLelang->master_sesi_lelang_id, $lelangSesiOnline->lelang_sesi_online_id, $lelang->lelang_id]) }}" class="btn btn-danger btn-block"><i class="fas fa-check"></i> Selesai</a>
                                        @endif

                                        @else
                                        <a href="{{ route('online.list.lelang_sesi', [$masterSesiLelang->master_sesi_lelang_id, $lelangSesiOnline->lelang_sesi_online_id, $lelang->lelang_id]) }}" class="btn btn-primary btn-block"><i class="fas fa-clock"></i> Belum Dimulai</a>
                                        @endif
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                    <a type="button" href="{{ route('online.list.show', [$masterSesiLelang->master_sesi_lelang_id, $lelangSesiOnline->lelang_sesi_online_id]) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
