...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('online.event.produk', $event->lelang_sesi_online_id) }}">Produk Event Lelang</a></div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-5 col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="{{ route('online.event.produk.sesi_doc', [$event->lelang_sesi_online_id, $lelang->lelang_id, 'pdf']) }}"><i class="fas fa-print"></i> Surat Perjanjian (PDF)</a>
                                </div>
                                <div class="col-12">
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3">
                            <div class="card card-primary">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{ route('online.event.produk.sesi', [$event->lelang_sesi_online_id, $lelang->lelang_id]) }}" class="btn btn-danger btn-block"><i class="fas fa-times"></i> Ditutup</a>
                                    ...
                                    <p class="text-center">{{ $event->tanggal . ', ('. $event->master_sesi_lelang()->first()->jam_mulai . '-'. $event->master_sesi_lelang()->first()->jam_berakhir .')' }}</p>
                                    <a href="{{ route('online.event.produk.sesi', [$event->lelang_sesi_online_id, $lelang->lelang_id]) }}" class="btn btn-primary btn-block"><i class="fas fa-clock"></i> Menunggu Sesi Lelang</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('online.event.produk', $event->lelang_sesi_online_id) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                                    </div>
                                </div>
                            </div>
                        </div>
