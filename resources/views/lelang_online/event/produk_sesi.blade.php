...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('online.event.produk.show', [$event->lelang_sesi_online_id, $lelang->lelang_id]) }}">Detail</a></div>
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-8">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-between">
                                ...
                                <div class="col-12 col-sm-12 col-md-8 text-center pl-8">
                                    ...
                                    <button class="btn btn-primary btn-block btn-lg" disabled><i class="fas fa-clock"></i> Menunggu Sesi Lelang</button>
                                    @else
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                @if($event->master_sesi_lelang()->first()->peserta_lelang()->count() > 0)
                                @foreach($event->master_sesi_lelang()->first()->peserta_lelang()->orderBy('kode_peserta_lelang', 'asc')->get() as $dpl)
