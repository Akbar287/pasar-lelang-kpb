...
<div class="section-header">
    <h1>Detail Riwayat Lelang Online</h1>
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></div>
        <div class="breadcrumb-item"><a href="{{ route('online.history') }}">Lelang Online</a></div>
        <div class="breadcrumb-item">Detail Lelang Online</div>
    </div>
</div>
<div class="section-body">
    <h2 class="section-title">Detail Riwayat Lelang Online</h2>
    <p class="section-lead">
        detail Riwayat Lelang Online.
    </p>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('online.history') }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        @if(is_null(Auth::user()->informasi_akun()->first()->peserta_lelang()->where('master_sesi_lelang_id', $masterSesiLelang->master_sesi_lelang_id)->where('tanggal', $lelangSesiOnline->tanggal)->first()))
