...
<div class="section-body">
    <h2 class="section-title">Tambah Gudang</h2>
    <p class="section-lead">
        Tambahkan data Gudang anda.
    </p>
    <div class="row justify-content-center">
        <div class="col-md-12">
            @if(session('msg')){!! session('msg') !!} @endif
            <form action="{{ route('master.lembaga.gudang.store') }}" method="post" enctype="multipart/form-data">@csrf 
                <div class="card">
                    <div class="card-header">
                        <h4>{{ __('Tambah Gudang') }}</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <input id="gudang_kode" type="text"
                                            class="form-control @error('gudang_kode') is-invalid @enderror" name="gudang_kode"
                                            value="{{ old("gudang_kode") }}" autocomplete="name"
                                            autofocus>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nama_gudang" type="text"
                                            ...
                                            value="{{ old("nama_gudang") }}" autocomplete="name"
                                            autofocus>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <input id="contact_number" type="text"
                                            ...
                                            value="{{ old("contact_number") }}" autocomplete="name"
                                            autofocus>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nama_pengelola" type="text"
                                            ...
                                            value="{{ old("nama_pengelola") }}" autocomplete="name"
                                            autofocus>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" cols="30" rows="10">{{ old("alamat") }}</textarea>
