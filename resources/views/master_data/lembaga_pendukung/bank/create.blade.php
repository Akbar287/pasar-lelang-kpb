...
<div class="section-body">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form action="{{ route('master.lembaga.bank.store') }}" method="post" enctype="multipart/form-data">@csrf 
                <div class="card">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <input id="kode_bank" type="text"
                                            ...
                                            value="{{ old("kode_bank") }}" autocomplete="name"
                                            autofocus>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nama_bank" type="text"
                                            ...
                                            value="{{ old("nama_bank") }}" autocomplete="name"
                                            autofocus>
