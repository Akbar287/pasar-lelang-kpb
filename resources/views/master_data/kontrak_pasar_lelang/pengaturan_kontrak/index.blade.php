...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Pengaturan Kontrak</div>
    </div>
</div>
<div class="section-body">
    <h2 class="section-title">Pengaturan Kontrak</h2>
    <p class="section-lead">
        Kelola Pengaturan Kontrak.
    </p>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('master.kontrak.pengaturan.create') }}" class="btn btn-primary">
                            Tambah
                        </a>
                    </div>
                </div>
