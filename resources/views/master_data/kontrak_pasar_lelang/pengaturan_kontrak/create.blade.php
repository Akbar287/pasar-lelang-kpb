...
<div class="section-body">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form action="{{ route('master.kontrak.pengaturan.store') }}" method="post" enctype="multipart/form-data">@csrf 
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <select class="custom-select @error('informasi_akun_id') is-invalid @enderror" name="informasi_akun_id" id="informasi_akun_id">
                                            ...
                                            <option {{ old('informasi_akun_id') == $ia->informasi_akun()->first()->informasi_akun_id ? 'selected' : '' }} value="{{ $ia->informasi_akun()->first()->informasi_akun_id }}">{{ $ia->ktp()->first()->nama . (!is_null($ia->lembaga_informasi_pic()->first()) ? ' ('. $ia->lembaga_informasi_pic()->first()->lembaga()->first()->nama_lembaga .')' : '' )}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <input id="simbol" type="text"
                                            ...
                                            value="{{ old("simbol") }}" autocomplete="name"
                                            autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-2">
                                            <input id="minimum_transaksi" type="text"
                                                ...
                                                value="{{ old("minimum_transaksi") }}" autocomplete="name"
                                                autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-2">
                                            <input id="maksimum_transaksi" type="text"
                                                ...
                                                value="{{ old("maksimum_transaksi") }}" autocomplete="name"
                                                autofocus>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <input id="fluktuasi_harga_harian" type="text"
                                            ...
                                            value="{{ old("fluktuasi_harga_harian") }}" autocomplete="name"
                                            autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-2">
                                            <input id="premium" type="text"
                                                ...
                                                value="{{ old("premium") }}" autocomplete="name"
                                                autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-2">
                                            <input id="diskon" type="text"
                                                ...
                                                value="{{ old("diskon") }}" autocomplete="name"
                                                autofocus>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <input id="jatuh_tempo_t_plus" type="number" min="0"
                                            class="form-control @error('jatuh_tempo_t_plus') is-invalid @enderror" name="jatuh_tempo_t_plus"
                                            value="{{ old("jatuh_tempo_t_plus") }}" autocomplete="name"
                                            autofocus>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <input id="tanggal_aktif" type="date"
                                            ...
                                            value="{{ old("tanggal_aktif") }}" autocomplete="name"
                                            autofocus>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <input id="tanggal_berakhir" type="date"
                                            ...
                                            value="{{ old("tanggal_berakhir") }}" autocomplete="name"
                                            autofocus>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('master.kontrak.pengaturan') }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
