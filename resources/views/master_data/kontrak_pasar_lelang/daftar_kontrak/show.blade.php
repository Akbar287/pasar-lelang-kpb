...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('master.kontrak.pengaturan') }}">Kontrak</a></div>
                        ...
                        <div class="col-md-12">
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                    <a type="button" href="{{ route('master.kontrak.list') }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                                    <a type="button" href="{{ route('master.kontrak.list.edit', $kontrak->kontrak_id) }}" class="btn mx-2 btn-success"><i class="fas fa-pen"></i> Ubah</a>
                                    <form action="{{ route('master.kontrak.list.destroy', $kontrak->kontrak_id) }}" method="POST">@csrf @method('delete')
                                        <button type="submit" onclick="return confirm('Kontrak akan dinon-aktifkan!\n Lanjutkan?')" title="Hapus Data" class="btn btn-danger"><i class="fas fa-times"></i> Non-Aktifkan</button>
                                    </form>
                                </div>
                            </div>
                        </div>
