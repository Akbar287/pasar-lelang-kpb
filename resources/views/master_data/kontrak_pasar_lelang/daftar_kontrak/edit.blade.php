...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('master.kontrak.list') }}">Pengaturan</a></div>
        <div class="breadcrumb-item"><a href="{{ route('master.kontrak.list.show', $kontrak->kontrak_id) }}">Detail</a></div>
...
<div class="section-body">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form action="{{ route('master.kontrak.list.update', $kontrak->kontrak_id) }}" method="post" enctype="multipart/form-data">@csrf @method('put')
                <div class="card">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <select class="custom-select @error('informasi_akun_id') is-invalid @enderror" name="informasi_akun_id" id="informasi_akun_id">
                                            ...
                                            <option {{ $kontrak->informasi_akun()->first()->informasi_akun_id == $ia->informasi_akun_id ? 'selected' : '' }} value="{{ $ia->informasi_akun_id }}">{{ !is_null($ia->member()->first()) ? $ia->member()->first()->ktp()->first()->nama : $ia->lembaga()->first()->nama_lembaga }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('master.kontrak.list.show', $kontrak->kontrak_id) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
