...
<div class="section-body">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="alert alert-danger">Informasi Keuangan Belum Lengkap.</div>
            @endif
            @if(is_null($calon->area_member()->first()))
            <div class="alert alert-danger">Alamat Belum lengkap.</div>
            @endif
            @if(is_null($calon->dokumen_member()->first()))
            <div class="alert alert-danger">Dokumen Member Belum Di Unggah ke sistem.</div>
            @endif
            @if(is_null($calon->rekening_bank()->first()))
            <div class="alert alert-danger">Rekening Bank Belum lengkap.</div>
            @endif
        </div>
        <div class="col-md-12">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="desa_lembaga" type="text" readonly class="form-control" name="desa_lembaga" value="{{ $calon->rekening_bank()->first()->mata_uang }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="jenis_kelamin" type="text" readonly class="form-control" name="jenis_kelamin" value="{{ $calon->member()->first()->ktp()->first()->jenis_kelamin }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="npwp" type="text" readonly
                                        class="form-control @error('npwp') is-invalid @enderror" name="npwp" value="{{ is_null($calon->member()->first()->informasi_keuangan()->first()) ? '-' : (is_null($calon->member()->first()->informasi_keuangan()->first()->npwp()) ? "Belum ada NPWP" : $calon->member()->first()->informasi_keuangan()->first()->npwp()->first()->npwp) }}" />
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="text" readonly
                                        class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $calon->email }}" />
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                        <input id="pekerjaan" type="text" readonly
                                            ...
                                            value="{{ is_null($calon->member()->first()->informasi_keuangan()->first()) ? '-' :$calon->member()->first()->informasi_keuangan()->first()->pekerjaan }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="username" type="text" class="form-control" readonly name="username" value="{{ is_null($calon->member()->first()->informasi_keuangan()->first()) ? '-' : $calon->member()->first()->informasi_keuangan()->first()->pendapatan_tahunan }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input id="kekayaan_bersih" type="text" readonly class="form-control thousand-style" name="kekayaan_bersih" value="{{ number_format(is_null($calon->member()->first()->informasi_keuangan()->first()) ? 0 : $calon->member()->first()->informasi_keuangan()->first()->kekayaan_bersih, 0, ".", ",") }}" />
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            ...
                                            <input id="kekayaan_lancar" type="text" readonly
                                                ...
                                                value="{{ number_format(is_null($calon->member()->first()->informasi_keuangan()->first()) ? 0 : $calon->member()->first()->informasi_keuangan()->first()->kekayaan_lancar, 0, ".", ",") }}" autocomplete="name"
                                                autofocus>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="username" type="text" class="form-control" readonly name="username" value="{{ is_null($calon->member()->first()->informasi_keuangan()->first()) ?'-' :$calon->member()->first()->informasi_keuangan()->first()->sumber_dana }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="bank" type="text" class="form-control" readonly name="bank" value="{{ is_null($calon->rekening_bank()->first()) ? 'Belum Dipilih' : (!is_null($calon->rekening_bank()->first()->bank()->first()) ? $calon->rekening_bank()->first()->bank()->first()->nama_bank : "Belum Dipilih") }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                        <input id="nomor_rekening" type="text" readonly class="form-control" name="nomor_rekening" value="{{ is_null($calon->rekening_bank()->first()) ? '-' : $calon->rekening_bank()->first()->nomor_rekening }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                        <input id="nama_pemilik" type="text" readonly class="form-control" name="nama_pemilik" value="{{ is_null($calon->rekening_bank()->first()) ? '-' :$calon->rekening_bank()->first()->nama_pemilik }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                        <input id="cabang" type="text" readonly
                                            class="form-control" name="cabang" value="{{ is_null($calon->rekening_bank()->first()) ? '-' :$calon->rekening_bank()->first()->cabang }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="mata_uang" type="text" class="form-control" readonly name="mata_uang" value="{{ is_null($calon->rekening_bank()->first()) ? '-' : $calon->rekening_bank()->first()->mata_uang }}" />
                                </div>
                            </div>
                        </div>
                    </div>
