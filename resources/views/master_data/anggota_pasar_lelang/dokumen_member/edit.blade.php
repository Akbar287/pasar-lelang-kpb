...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('master.anggota.list.dokumen.show', [$anggota->informasi_akun_id, $dokumen->dokumen_member_id]) }}">Detail Dokumen Anggota</a></div>
...
<div class="section-body">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form action="{{ route('master.anggota.list.dokumen.update',[$anggota->informasi_akun_id, $dokumen->dokumen_member_id]) }}" method="post" enctype="multipart/form-data">@csrf @method('put')
                <div class="card">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <select class="custom-select @error('jenis_dokumen_id') is-invalid @enderror" name="jenis_dokumen_id" id="jenis_dokumen_id">
                                            ...
                                            <option {{ $dokumen->jenis_dokumen()->first()->jenis_dokumen_id == $dok->jenis_dokumen_id ? 'selected' : '' }} value="{{ $dok->jenis_dokumen_id }}">{{ $dok->nama_jenis }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('master.anggota.list.dokumen.show',[$anggota->informasi_akun_id, $dokumen->dokumen_member_id]) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
