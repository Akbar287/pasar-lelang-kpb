...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('master.anggota.list.rekening.show', [$anggota->informasi_akun_id, $rekening->rekening_bank_id]) }}">Detail Rekening Bank</a></div>
...
<div class="section-body">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form action="{{ route('master.anggota.list.rekening.update',[$anggota->informasi_akun_id, $rekening->rekening_bank_id]) }}" method="post" enctype="multipart/form-data">@csrf @method('put')
                <div class="card">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <select class="custom-select @error('bank_id') is-invalid @enderror" name="bank_id" id="bank_id">
                                            ...
                                            @foreach($bank as $ba)
                                            <option {{ $rekening->bank()->first()->bank_id == $ba->bank_id ? 'selected' : '' }} value="{{ $ba->bank_id }}">{{ $ba->nama_bank }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('master.anggota.list.rekening.show',[$anggota->informasi_akun_id, $rekening->rekening_bank_id]) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
