...
<div class="section-body">
    <h2 class="section-title">Detail Calon Anggota</h2>
    <p class="section-lead">
        Detail data Calon Anggota anda.
    </p>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        ...
                                        <a type="button" href="{{ route('master.anggota.calon.edit', $calon->informasi_akun_id) }}" class="btn mx-2 btn-success"><i class="fas fa-pen"></i> Ubah</a>
                                        <form action="{{ route('master.anggota.calon.destroy', $calon->informasi_akun_id) }}" method="POST">@csrf @method('delete')
                                            <button type="submit" onclick="return confirm('Calon Anggota akan dihapus!\n Lanjutkan?')" title="Hapus Data" class="btn btn-danger"><i class="fas fa-trash"></i> Hapus</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
