...
<div class="row">
    <div class="col-12 mb-4">
        <div class="row mb-4">
            <div class="col-12">
                <a href="{{ route('welcome.online_lelang', $lelang->lelang_id) }}" class="btn btn-primary">Kembali</a>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-12 col-sm-12 col-md-8 text-center pl-8">
                                ...
                                <button class="btn btn-success btn-block btn-lg d-none bid_btn" disabled><i class="fas fa-gavel"></i> Anda Perlu Login</button>
                                @endif
                            </div>
                        </div>
