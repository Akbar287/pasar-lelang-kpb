                    ...
                    <div class="col-12 col-sm-12 col-md-4">
                        <div class="card card-primary">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('online.list.lelang_sesi', [$masterSesiLelang->master_sesi_lelang_id, $lelang->lelang_sesi_online()->first()->lelang_sesi_online_id, $lelang->lelang_id]) }}" class="btn btn-danger btn-block"><i class="fas fa-times"></i> Ditutup</a>
                                @elseif($lelang->status_lelang_pivot()->join('status_lelang', 'status_lelang.status_lelang_id', 'status_lelang_pivot.status_lelang_id')->where('status_lelang.nama_status', 'Aktif')->count() > 0)
                                    @if($lelang->peserta_lelang_aktif()->where('master_sesi_lelang_id', $lelang->lelang_sesi_online()->first()->master_sesi_lelang()->first()->master_sesi_lelang_id)->where('lelang_sesi_online_id', $lelang->lelang_sesi_online()->first()->lelang_sesi_online_id)->count() > 0)

                                    @if($lelang->peserta_lelang_aktif()->where('master_sesi_lelang_id', $lelang->lelang_sesi_online()->first()->master_sesi_lelang()->first()->master_sesi_lelang_id)->where('lelang_sesi_online_id', $lelang->lelang_sesi_online()->first()->lelang_sesi_online_id)->first()->aktif)
                                    <a href="{{ route('welcome.online_lelang_sesi', $lelang->lelang_id) }}" class="btn btn-primary btn-block"><i class="fas fa-clock"></i> Masuk</a>
                                    @else
                                    <a href="{{ route('welcome.online_lelang_sesi', $lelang->lelang_id) }}" class="btn btn-danger btn-block"><i class="fas fa-check"></i> Selesai</a>
                                    @endif

                                    @else
                                    <a href="{{ route('welcome.online_lelang_sesi', $lelang->lelang_id) }}" class="btn btn-primary btn-block"><i class="fas fa-clock"></i> Belum Dimulai</a>
                                    @endif
                                @endif
                            </div>
                        </div>
