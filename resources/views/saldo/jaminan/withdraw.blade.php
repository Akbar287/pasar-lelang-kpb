...
<div class="section-header">
    <h1>Withdraw Jaminan</h1>
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></div>
        <div class="breadcrumb-item"><a href="{{ route('home.saldo.jaminan') }}">Saldo Jaminan</a></div>
        <div class="breadcrumb-item">Withdraw Jaminan</div>
    </div>
</div>
<div class="section-body">
    <h2 class="section-title">Withdraw Jaminan</h2>
    <p class="section-lead">
        Lihat Withdraw Jaminan anda.
    </p>
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4>{{ __('Withdraw Jaminan') }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('home.saldo.jaminan.withdraw_store') }}" method="post" enctype="multipart/form-data">@csrf
                        <div class="row">
                            <div class="col-12 col-md-12 ">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    <a href="{{ route('home.saldo.jaminan') }}" type="button" class="btn btn-primary mr-2">Kembali</a>
