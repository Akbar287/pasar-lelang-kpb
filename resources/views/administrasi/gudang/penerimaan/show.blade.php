                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        ...
                                        <a type="button" href="{{ route('administrasi.gudang.penerimaan.edit', $registrasi->registrasi_komoditas_id) }}" class="btn mx-2 btn-success"><i class="fas fa-pen"></i> Ubah</a>
                                        <form action="{{ route('administrasi.gudang.penerimaan.destroy', $registrasi->registrasi_komoditas_id) }}" method="POST">@csrf @method('delete')
