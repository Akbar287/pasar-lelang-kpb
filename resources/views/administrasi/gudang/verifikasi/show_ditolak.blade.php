...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('administrasi.gudang.verifikasi.index_ditolak') }}">Ditolak</a></div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="keterangan" {{ !is_null($registrasi->verified_log()->first()) ? 'readonly' : '' }} class="form-control  @error('keterangan') is-invalid @enderror" name="keterangan" type="text" cols="30" rows="10">{{ !is_null($registrasi->verified_log()->first()) ? $registrasi->verified_log()->first()->keterangan : '' }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('administrasi.gudang.verifikasi.index_ditolak') }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        @if(!is_null($registrasi->verified_log()->first()))
                                        <form action="{{ route('administrasi.gudang.verifikasi.confirmation_ulang', $registrasi->registrasi_komoditas_id) }}" method="post"> @csrf @method('put')
                                            <button type="submit" href="{{ route('administrasi.gudang.verifikasi.confirmation_ulang', $registrasi->registrasi_komoditas_id) }}" class="btn mx-2 btn-success"><i class="fas fa-pen"></i> Verifikasi Ulang</button>
                                        </form>
                                        @endif
                                    </div>
                                </div>
