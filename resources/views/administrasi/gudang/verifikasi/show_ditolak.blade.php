...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('administrasi.kas_bank.verifikasi.index_ditolak') }}">Ditolak</a></div>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('administrasi.kas_bank.verifikasi.index_ditolak') }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        @if(!is_null($keuangan->verified_log()->first()))
                                        <form action="{{ route('administrasi.kas_bank.verifikasi.confirmation_ulang', $keuangan->keuangan_id) }}" method="post"> @csrf @method('put')
                                            <button type="submit" href="{{ route('administrasi.kas_bank.verifikasi.confirmation_ulang', $keuangan->keuangan_id) }}" class="btn mx-2 btn-success"><i class="fas fa-pen"></i> Verifikasi Ulang</button>
                                        </form>
                                        @endif
                                    </div>
                                </div>
