...
<div class="section-header">
    <h1>Verifikasi Pengeluaran Jaminan</h1>
...
<div class="section-body">
    <h2 class="section-title">Detail Verifikasi Pengeluaran Jaminan</h2>
    <p class="section-lead">
        Detail data Verifikasi Pengeluaran Jaminan anda.
    </p>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>{{ __('Verifikasi Pengeluaran Jaminan') }}</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <form action="{{ route('administrasi.jaminan.pengeluaran.verifikasi.confirmation', $pengeluaranJaminan->pengeluaran_jaminan_id) }}" method="post"> @csrf @method('put')
                <div class="card">
                    <div class="card-header">
                        <h4>{{ __('Verifikasi') }}</h4>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('administrasi.jaminan.pengeluaran.verifikasi.index') }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        @if(is_null($pengeluaranJaminan->verified_log()->first()))
