...
<div class="section-body">
    <h2 class="section-title">Penerimaan Jaminan Kas</h2>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('administrasi.jaminan.penerimaan.kas.create', $detailJaminan->detail_jaminan_id) }}" class="btn btn-primary">
                            Tambah
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-jaminan-kas">
                            <thead>
                                <tr>
