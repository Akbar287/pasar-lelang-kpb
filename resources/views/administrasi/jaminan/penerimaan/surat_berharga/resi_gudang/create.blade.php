...
<div class="section-body">
    <h2 class="section-title">Tambah Penerimaan Jaminan Resi Gudang</h2>
    <p class="section-lead">
        Tambahkan data Penerimaan Jaminan Resi Gudang.
    </p>
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <form action="{{ route('administrasi.jaminan.penerimaan.resi_gudang.store', $detailJaminan->detail_jaminan_id) }}" method="post" enctype="multipart/form-data">@csrf 
                <div class="card">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="pemegang_resi_gudang" type="text"
                                                ...
                                                value="{{ old("pemegang_resi_gudang") }}" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="tanggal_penerbitan" type="date"
                                                ...
                                                value="{{ is_null(old("tanggal_penerbitan")) ? date('Y-m-d') : old("tanggal_penerbitan") }}" />
