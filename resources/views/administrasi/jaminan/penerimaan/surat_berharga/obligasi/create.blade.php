...
<div class="section-body">
    <h2 class="section-title">Tambah Penerimaan Jaminan Obligasi</h2>
    <p class="section-lead">
        Tambahkan data Penerimaan Jaminan Obligasi.
    </p>
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <form action="{{ route('administrasi.jaminan.penerimaan.obligasi.store', $detailJaminan->detail_jaminan_id) }}" method="post" enctype="multipart/form-data">@csrf 
                <div class="card">
