...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Saham</div>
    </div>
</div>
<div class="section-body">
    <h2 class="section-title">Penerimaan Jaminan Saham</h2>
    <p class="section-lead">
        Kelola Jaminan Saham.
    </p>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('administrasi.jaminan.penerimaan.saham.create', $detailJaminan->detail_jaminan_id) }}" class="btn btn-primary">
                            Tambah
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-jaminan-saham">
                            <thead>
                                <tr>
                                    <th>Kode Saham</th>
                                    <th>Lot</th>
