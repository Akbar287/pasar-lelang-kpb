...
<div class="section-header">
    <h1>Jaminan Penerimaan</h1>
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></div>
        <div class="breadcrumb-item"><a href="{{ route('administrasi') }}">Administrasi</a></div>
        <div class="breadcrumb-item"><a href="{{ route('administrasi.jaminan') }}">Jaminan Penerimaan</a></div>
        <div class="breadcrumb-item"><a href="{{ route('administrasi.jaminan.penerimaan.verifikasi.index') }}">Verifikasi</a></div>
        <div class="breadcrumb-item"><a href="{{ route('administrasi.jaminan.penerimaan.verifikasi.index_ditolak') }}">Ditolak</a></div>
        <div class="breadcrumb-item">Detail</div>
    </div>
</div>
<div class="section-body">
    <h2 class="section-title">Detail Jaminan Penerimaan</h2>
    <p class="section-lead">
        Detail data Jaminan Penerimaan anda.
    </p>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="keterangan" {{ !is_null($detailJaminan->verified_log()->first()) ? 'readonly' : '' }} class="form-control  @error('keterangan') is-invalid @enderror" name="keterangan" type="text" cols="30" rows="10">{{ !is_null($detailJaminan->verified_log()->first()) ? $detailJaminan->verified_log()->first()->keterangan : '' }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('administrasi.jaminan.penerimaan.verifikasi.index_ditolak') }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        @if(!is_null($detailJaminan->verified_log()->first()))
                                        <form action="{{ route('administrasi.jaminan.penerimaan.verifikasi.confirmation_ulang', $detailJaminan->detail_jaminan_id) }}" method="post"> @csrf @method('put')
                                            <button type="submit" href="{{ route('administrasi.jaminan.penerimaan.verifikasi.confirmation_ulang', $detailJaminan->detail_jaminan_id) }}" class="btn mx-2 btn-success"><i class="fas fa-pen"></i> Verifikasi Ulang</button>
                                        </form>
                                        @endif
                                    </div>
                                </div>
