...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Kas</div>
    </div>
</div>
<div class="section-body">
    <h2 class="section-title">Penerimaan Jaminan Komoditas</h2>
    <p class="section-lead">
        Kelola Jaminan Komoditas.
    </p>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('administrasi.jaminan.penerimaan.komoditas.create', $detailJaminan->detail_jaminan_id) }}" class="btn btn-primary">
                            Tambah
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-jaminan-komoditas">
                            <thead>
                                <tr>
                                    <th>Komoditi</th>
                                    <th>Kuantitas</th>
                                    <th>Unit</th>
                                    <th>Nilai Perkiraan</th>
