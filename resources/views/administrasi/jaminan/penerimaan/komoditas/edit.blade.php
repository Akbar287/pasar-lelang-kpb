...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('administrasi.jaminan.penerimaan.komoditas.show', [$detailJaminan->detail_jaminan_id, $komoditas->registrasi_komoditas_jaminan_id]) }}">Detail</a></div>
        <div class="breadcrumb-item">Ubah</div>
    </div>
</div>
<div class="section-body">
    <h2 class="section-title">Ubah Jaminan Komoditas</h2>
    <p class="section-lead">
        Ubah data Jaminan Komoditas anda.
    </p>
    <div class="row justify-content-center">
        <div class="col-md-12">
            @if(session('msg')){!! session('msg') !!} @endif
            <form action="{{ route('administrasi.jaminan.penerimaan.komoditas.update', [$detailJaminan->detail_jaminan_id, $komoditas->registrasi_komoditas_jaminan_id]) }}" method="post" enctype="multipart/form-data">@csrf @method('put')
                <div class="card">
                    <div class="card-header">
                        <h4>{{ __('Jaminan Komoditas') }}</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <input id="komoditi" type="text"
                                                ...
                                                value="{{ $komoditas->komoditi }}" autocomplete="name"
                                                autofocus>
                                        </div>
                                            @error('komoditi')
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <input id="kadaluarsa" type="date"
                                                ...
                                                value="{{ $komoditas->kadaluarsa }}" autocomplete="name"
                                                autofocus>
                                        </div>
                                            @error('kadaluarsa')
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <input id="kuantitas" type="text"
                                                ...
                                                value="{{ $komoditas->kuantitas }}" autocomplete="name"
                                                autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <input id="unit" type="text"
                                                ...
                                                value="{{ $komoditas->unit }}" autocomplete="name"
                                                autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="nilai_perkiraan" type="text"
                                                ...
                                                value="{{ $komoditas->nilai_perkiraan }}" autocomplete="name"
                                                autofocus>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="haircut" type="text"
                                                ...
                                                value="{{ $komoditas->haircut }}" autocomplete="name"
                                                autofocus>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="nilai_penyesuaian" type="text"
                                                ...
                                                value="{{ $komoditas->nilai_penyesuaian }}" autocomplete="name"
                                                autofocus>
                                        </div>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="lokasi" class="form-control @error('lokasi') is-invalid @enderror"  name="lokasi" type="text" cols="30" rows="10">{{ $komoditas->lokasi }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('administrasi.jaminan.penerimaan.komoditas.show', [$detailJaminan->detail_jaminan_id, $komoditas->registrasi_komoditas_jaminan_id]) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
