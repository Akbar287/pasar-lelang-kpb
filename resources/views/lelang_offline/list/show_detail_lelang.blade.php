                        ...
                        <div class="col-12 col-sm-12 col-md-4">
                            <div class="card card-primary">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{ route('offline.list.sesi_lelang', [$eventLelang->event_lelang_id, $lelang->lelang_id]) }}" class="btn btn-danger btn-block"><i class="fas fa-times"></i> Ditutup</a>
                                    ...
                                    @if(is_null($lelang->daftar_peserta_lelang_aktif()->where('event_lelang_id', $eventLelang->event_lelang_id)->first()))
                                    <button disabled href="{{ route('offline.list.sesi_lelang', [$eventLelang->event_lelang_id, $lelang->lelang_id]) }}" class="btn btn-primary btn-block"><i class="fas fa-clock"></i> Menunggu Sesi Lelang</button>
                                    @else

                                    @if($lelang->daftar_peserta_lelang_aktif()->where('event_lelang_id', $eventLelang->event_lelang_id)->first()->aktif)
                                    <a href="{{ route('offline.list.sesi_lelang', [$eventLelang->event_lelang_id, $lelang->lelang_id]) }}" class="btn btn-primary btn-block"><i class="fas fa-clock"></i> Masuk</a>
                                    @else
                                    <a href="{{ route('offline.list.sesi_lelang', [$eventLelang->event_lelang_id, $lelang->lelang_id]) }}" class="btn btn-danger btn-block"><i class="fas fa-times"></i> Ditutup</a>
                                    @endif
                        ...
                        <div class="col-md-12">
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                    <a type="button" href="{{ route('offline.list.show', $eventLelang->event_lelang_id) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
