                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        ...
                                        <a type="button" href="{{ route('offline.event.anggota.edit', [$event->event_lelang_id, $anggota->daftar_peserta_lelang_id]) }}" class="btn mr-2 btn-success"><i class="fas fa-pen"></i> Ubah</a>
                                        <form action="{{ route('offline.event.anggota.destroy', [$event->event_lelang_id, $anggota->daftar_peserta_lelang_id]) }}" method="POST">@csrf @method('delete')
