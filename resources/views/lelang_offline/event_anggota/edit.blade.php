...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('offline.event.anggota.show', [$event->event_lelang_id, $anggota->daftar_peserta_lelang_id]) }}">Detail Anggota</a></div>
...
<div class="section-body">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form action="{{ route('offline.event.anggota.update', [$event->event_lelang_id, $anggota->daftar_peserta_lelang_id]) }}" method="post" enctype="multipart/form-data">@csrf @method('put')
                <div class="card">
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('offline.event.anggota.show', [$event->event_lelang_id, $anggota->daftar_peserta_lelang_id]) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
