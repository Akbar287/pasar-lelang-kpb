                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-12 d-flex align-items-end">
                                        ...
                                        {{-- @if($event->status_event_lelang()->first()->nama_status == 'Lelang Baru') --}}
                                        <a type="button" href="{{ route('offline.event.edit', $event->event_lelang_id) }}" class="btn mr-2 btn-success"><i class="fas fa-pen"></i> Ubah</a>
                                        {{-- @endif --}}
                                        ...
                                        @if($event->status_event_lelang()->first()->nama_status == 'Sinkronisasi Anggota Lelang')
                                        <a type="button" href="{{ route('offline.event.anggota', $event->event_lelang_id) }}" class="btn mr-2 btn-info"><i class="fas fa-user"></i> Anggota Lelang</a>
                                        @endif
                                        ...
                                        <form action="{{ route('offline.event.destroy', $event->event_lelang_id) }}" method="POST">@csrf @method('delete')
                                            <button type="submit" onclick="return confirm('Data Event akan dihapus!\n Lanjutkan?')" title="Hapus Data" class="btn btn-danger"><i class="fas fa-trash"></i> Hapus</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
