...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('offline.event.produk.show', [$event->event_lelang_id, $lelang->lelang_id]) }}">Detail</a></div>
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-8">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-between">
                                ...
                                <div class="col-12 col-sm-12 col-md-8 text-center pl-8">
                                    ...
                                    <button class="btn btn-warning btn-block btn-lg" id="start_lelang">Mulai Sesi Lelang</button>
                                    <button class="btn btn-danger btn-block btn-lg d-none" id="stop_lelang">Stop Sesi</button>
                                    <div class="row d-none" id="btn_finish_lelang">
                                        <div class="col-6">
                                            <button class="btn btn-primary btn-block btn-lg" id="reset_lelang">Reset Sesi</button>
                                        </div>
                                        <div class="col-6">
                                            <button class="btn btn-success btn-block btn-lg" id="selesai_lelang">Simpan Sesi</button>
                                        </div>
                                    </div>
                                    @endif
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                @if($event->daftar_peserta_lelang()->count() > 0)
                                @foreach($event->daftar_peserta_lelang()->orderBy('kode_peserta_lelang', 'asc')->get() as $dpl)
                                <div class="col-4 col-sm-4 col-md-3 col-lg-2 my-1">
                                    @if($dpl->informasi_akun_id == $lelang->kontrak()->first()->informasi_akun_id)
                                    <button type="button" data-kode="{{ $dpl->kode_peserta_lelang }}" disabled class="btn btn-primary btn-block btn-rounded">{{ $dpl->kode_peserta_lelang }}</button>
                                    @else
