...
<div class="section-body">
    <h2 class="section-title">Tambah Area</h2>
    <p class="section-lead">
        Tambahkan data Area anda.
    </p>
    <div class="row justify-content-center">
        <div class="col-md-12">
            @if(session('msg')){!! session('msg') !!} @endif
            <form action="{{ route('home.profil.area.store') }}" method="post" enctype="multipart/form-data">@csrf 
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <select class="custom-select @error('provinsi_id') is-invalid @enderror" name="provinsi_id" id="provinsi_id">
                                            ...
                                            <option {{ old('provinsi_id') == $p->provinsi_id ? 'selected' : '' }} value="{{ $p->provinsi_id }}">{{ $p->nama_provinsi }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <select disabled class="custom-select @error('kabupaten_id') is-invalid @enderror" name="kabupaten_id" id="kabupaten_id">
                                        </select>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <select disabled class="custom-select @error('kecamatan_id') is-invalid @enderror" name="kecamatan_id" id="kecamatan_id">
                                        </select>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <select disabled class="custom-select @error('desa_id') is-invalid @enderror" name="desa_id" id="desa_id">
                                        </select>
