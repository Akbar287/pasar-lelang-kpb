...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('home.profil.dokumen') }}">Dokumen Member</a></div>
...
<div class="section-body">
    ...
    <p class="section-lead">
        Tambahkan data Dokumen anda.
    </p>
    <div class="row justify-content-center">
        <div class="col-md-12">
            @if(session('msg')){!! session('msg') !!} @endif
            <form action="{{ route('home.profil.dokumen.store') }}" method="post" enctype="multipart/form-data">@csrf 
                <div class="card">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <select class="custom-select @error('jenis_dokumen_id') is-invalid @enderror" name="jenis_dokumen_id" id="jenis_dokumen_id">
                                            ...
                                            <option {{ old('jenis_dokumen_id') == $jd->jenis_dokumen_id ? 'selected' : '' }} value="{{ $jd->jenis_dokumen_id }}">{{ $jd->nama_jenis }}</option>
                                            @endforeach
                                        </select>
