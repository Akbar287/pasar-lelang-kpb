...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('konfigurasi.jenis.inisiasi') }}">Perdagangan</a></div>
        <div class="breadcrumb-item">Tambah</div>
    </div>
</div>
<div class="section-body">
    <h2 class="section-title">Tambah Jenis Inisiasi</h2>
    <p class="section-lead">
        Tambahkan data Jenis Inisiasi anda.
    </p>
    <div class="row justify-content-center">
        <div class="col-md-12">
            @if(session('msg')){!! session('msg') !!} @endif
            <form action="{{ route('konfigurasi.jenis.inisiasi.store') }}" method="post" enctype="multipart/form-data">@csrf 
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row mb-3 justify-content-center">
                                    <label for="nama_perdagangan" class="col-md-4 col-form-label text-md-end">{{ __('Nama Inisiasi') }}</label>
            
                                    <div class="col-md-6">
                                        <input id="nama_inisiasi" type="text"
                                            class="form-control @error('nama_inisiasi') is-invalid @enderror" name="nama_inisiasi"
                                            value="{{ old("nama_inisiasi") }}" />
