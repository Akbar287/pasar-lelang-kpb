...
<div class="section-body">
    <h2 class="section-title">Tambah Jenis Harga</h2>
    <p class="section-lead">
        Tambahkan data Jenis Harga anda.
    </p>
    <div class="row justify-content-center">
        <div class="col-md-12">
            @if(session('msg')){!! session('msg') !!} @endif
            <form action="{{ route('konfigurasi.jenis.harga.store') }}" method="post" enctype="multipart/form-data">@csrf 
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row mb-3 justify-content-center">
                                    <label for="nama_jenis_harga" class="col-md-4 col-form-label text-md-end">{{ __('Nama Jenis Harga') }}</label>
            
                                    <div class="col-md-6">
                                        <input id="nama_jenis_harga" type="text"
                                            class="form-control @error('nama_jenis_harga') is-invalid @enderror" name="nama_jenis_harga"
                                            value="{{ old("nama_jenis_harga") }}" />
