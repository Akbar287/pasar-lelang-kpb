...
<div class="section-body">
    <h2 class="section-title">Tambah Status event Lelang</h2>
    <p class="section-lead">
        Tambahkan data Status event Lelang anda.
    </p>
    <div class="row justify-content-center">
        <div class="col-md-12">
            @if(session('msg')){!! session('msg') !!} @endif
            <form action="{{ route('konfigurasi.status.event_lelang.store') }}" method="post" enctype="multipart/form-data">@csrf 
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row mb-3 justify-content-center">
                                    <label for="nama_status" class="col-md-4 col-form-label text-md-end">{{ __('Nama Status') }}</label>
