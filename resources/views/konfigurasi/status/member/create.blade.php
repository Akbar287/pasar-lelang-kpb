...
<div class="section-body">
    <h2 class="section-title">Tambah Status Member</h2>
    <p class="section-lead">
        Tambahkan data Status Member anda.
    </p>
    <div class="row justify-content-center">
        <div class="col-md-12">
            @if(session('msg')){!! session('msg') !!} @endif
            <form action="{{ route('konfigurasi.status.member.store') }}" method="post" enctype="multipart/form-data">@csrf 
                <div class="card">
