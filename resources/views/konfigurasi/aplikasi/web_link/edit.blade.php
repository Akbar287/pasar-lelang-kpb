...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('konfigurasi.aplikasi.web_link.show', $webLink->web_links_id) }}">Web Link</a></div>
        <div class="breadcrumb-item">Ubah</div>
    </div>
</div>
<div class="section-body">
    <h2 class="section-title">Ubah Web Link</h2>
    <p class="section-lead">
        Ubahkan data Web Link.
    </p>
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <form action="{{ route('konfigurasi.aplikasi.web_link.update', $webLink->web_links_id) }}" method="post" enctype="multipart/form-data">@csrf @method('put')
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <select name="aplikasi_id" id="aplikasi_id" class="form-control @error('aplikasi_id') is-invalid @enderror">
                                                ...
                                                <option {{ $webLink->aplikasi_id == $apl->aplikasi_id ? 'selected' : '' }} value="{{ $apl->aplikasi_id }}">{{ $apl->nama_aplikasi }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @error('aplikasi_id')
                                ...
                                <div class="row mb-3 justify-content-center reg-in">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <textarea id="link" class="form-control @error('link') is-invalid @enderror" name="link" cols="30" rows="10">{{ $webLink->link }}</textarea>
                                        </div>
                                        @error('link')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('konfigurasi.aplikasi.web_link.show', $webLink->web_links_id) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
