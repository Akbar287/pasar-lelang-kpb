...
<div class="section-body">
    <h2 class="section-title">Tambah Carousel</h2>
    <p class="section-lead">
        Tambahkan data Carousel.
    </p>
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <form action="{{ route('konfigurasi.aplikasi.carousel.store') }}" method="post" enctype="multipart/form-data">@csrf
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row mb-3 justify-content-center reg-in">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <textarea id="subtitle" class="form-control @error('subtitle') is-invalid @enderror" name="subtitle" cols="30" rows="10">{{ old('subtitle') }}</textarea>
                                        </div>
                                        @error('subtitle')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3 justify-content-center reg-in">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <input id="urutan" class="form-control @error('urutan') is-invalid @enderror" name="urutan" value="{{ old('urutan') }}" type="number" />
                                        </div>
                                        @error('urutan')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="row mb-3 justify-content-center reg-in">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <input id="page" class="form-control @error('page') is-invalid @enderror" name="page" value="{{ old('page') }}" type="text" />
                                        </div>
                                        @error('page')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
