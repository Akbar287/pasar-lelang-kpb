...
<div class="section-body">
    <h2 class="section-title">Ubah Kecamatan</h2>
    <p class="section-lead">
        Ubah data Kecamatan anda.
    </p>
    <div class="row justify-content-center">
        <div class="col-md-12">
            @if(session('msg')){!! session('msg') !!} @endif
            <form action="{{ route('konfigurasi.area.provinsi.kabupaten.kecamatan.update', [$provinsi->provinsi_id, $kabupaten->kabupaten_id, $kecamatan->kecamatan_id]) }}" method="post" enctype="multipart/form-data">@csrf @method('put')
                <div class="card">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="nama_kecamatan" type="text"
                                                ...
                                                value="{{ $kecamatan->nama_kecamatan }}" autocomplete="name"
                                                autofocus>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('konfigurasi.area.provinsi.kabupaten.kecamatan.show', [$provinsi->provinsi_id, $kabupaten->kabupaten_id, $kecamatan->kecamatan_id]) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
