...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('konfigurasi.area.provinsi.kabupaten.kecamatan.desa.show', [$provinsi->provinsi_id, $kabupaten->kabupaten_id, $kecamatan->kecamatan_id, $desa->desa_id]) }}">Detail</a></div>
        <div class="breadcrumb-item">Ubah</div>
    </div>
</div>
<div class="section-body">
    <h2 class="section-title">Ubah Desa</h2>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form action="{{ route('konfigurasi.area.provinsi.kabupaten.kecamatan.desa.update', [$provinsi->provinsi_id, $kabupaten->kabupaten_id, $kecamatan->kecamatan_id, $desa->desa_id]) }}" method="post" enctype="multipart/form-data">@csrf @method('put')
                <div class="card">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="nama_desa" type="text"
                                                ...
                                                value="{{ $desa->nama_desa }}" autocomplete="name"
                                                autofocus>
                                        </div>
                                        @error('nama_desa')
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('konfigurasi.area.provinsi.kabupaten.kecamatan.desa.show', [$provinsi->provinsi_id, $kabupaten->kabupaten_id, $kecamatan->kecamatan_id, $desa->desa_id]) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
