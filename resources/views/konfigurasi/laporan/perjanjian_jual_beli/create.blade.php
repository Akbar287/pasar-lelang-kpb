...
<div class="section-body">
    <h2 class="section-title">Tambah Perjanjian Jual Beli</h2>
    <p class="section-lead">
        Tambahkan data Perjanjian Jual Beli anda.
    </p>
    <div class="row justify-content-center">
        <div class="col-md-12">
            @if(session('msg')){!! session('msg') !!} @endif
            <form action="{{ route('konfigurasi.laporan.perjanjian_jual_beli.store') }}" method="post" enctype="multipart/form-data">@csrf 
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="value" type="text" class="form-control @error('value') is-invalid @enderror" name="value" cols="30" rows="10">{{ old("value") }}</textarea>
