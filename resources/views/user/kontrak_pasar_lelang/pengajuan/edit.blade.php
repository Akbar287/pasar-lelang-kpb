...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('kontrak.pengajuan.show', $kontrak->kontrak_id) }}">Detail</a></div>
...
<div class="section-body">
    ...
    <p class="section-lead">
        Ubahkan data Kontrak anda.
    </p>
    <div class="row justify-content-center">
        <div class="col-md-12">
            @if(session('msg')){!! session('msg') !!} @endif
            <form action="{{ route('kontrak.pengajuan.update', $kontrak->kontrak_id) }}" method="post" enctype="multipart/form-data">@csrf @method('put')
                <div class="card">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <select class="custom-select @error('penyelenggara_pasar_lelang_id') is-invalid @enderror" name="penyelenggara_pasar_lelang_id" id="penyelenggara_pasar_lelang_id">
                                            ...
                                            <option {{ $kontrak->penyelenggara_pasar_lelang_id == $ppl->penyelenggara_pasar_lelang_id ? 'selected' : '' }} value="{{ $ppl->penyelenggara_pasar_lelang_id }}">{{ $ppl->admin()->first()->member()->first()->ktp()->first()->nama }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <select class="custom-select @error('jenis_perdagangan_id') is-invalid @enderror" name="jenis_perdagangan_id" id="jenis_perdagangan_id">
                                            ...
                                            <option {{ $kontrak->jenis_perdagangan_id == $jp->jenis_perdagangan_id ? 'selected' : '' }} value="{{ $jp->jenis_perdagangan_id }}">{{ $jp->nama_perdagangan }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <select class="custom-select @error('komoditas_id') is-invalid @enderror" name="komoditas_id" id="komoditas_id">
                                            ...
                                            <option {{ $kontrak->komoditas_id == $kom->komoditas_id ? 'selected' : '' }} value="{{ $kom->komoditas_id }}">{{ $kom->nama_komoditas }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <select class="custom-select @error('mutu_id') is-invalid @enderror" name="mutu_id" id="mutu_id">
                                            @foreach($mutu as $m)
                                            <option {{ $kontrak->mutu_id == $m->mutu_id ? 'selected' : '' }} value="{{ $m->mutu_id }}">{{ $m->nama_mutu }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('kontrak.pengajuan.show', $kontrak->kontrak_id) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
