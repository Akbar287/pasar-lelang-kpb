                        ...
                        <div class="col-md-12">
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                    ...
                                    <a type="button" href="{{ route('lelang.pengajuan.file', $lelang->lelang_id) }}" class="btn btn-info mr-2"><i class="fas fa-file"></i> Dokumen</a>
                                    <a type="button" href="{{ route('lelang.pengajuan.edit', $lelang->lelang_id) }}" class="btn mx-2 btn-success"><i class="fas fa-pen"></i> Ubah</a>
                                    <form action="{{ route('lelang.pengajuan.destroy', $lelang->lelang_id) }}" method="POST">@csrf @method('delete')
