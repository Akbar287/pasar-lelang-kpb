...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('lelang.pengajuan.file.show', [$lelang->lelang_id, $file->dokumen_produk_id]) }}">Detail File</a></div>
        <div class="breadcrumb-item">Ubah</div>
    </div>
</div>
<div class="section-body">
    <h2 class="section-title">Ubah File Lelang</h2>
    <p class="section-lead">
        Ubah File Lelang anda.
    </p>
    <div class="row justify-content-center">
        <div class="col-md-12">
            @if(session('msg')){!! session('msg') !!} @endif
            <form action="{{ route('lelang.pengajuan.file.update', [$lelang->lelang_id, $file->dokumen_produk_id]) }}" method="post" enctype="multipart/form-data">@csrf @method('put')
                <div class="card">
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('lelang.pengajuan.file.show', [$lelang->lelang_id, $file->dokumen_produk_id]) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
