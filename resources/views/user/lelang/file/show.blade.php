...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Detail File</div>
    </div>
</div>
<div class="section-body">
    <h2 class="section-title">Detail File Lelang</h2>
                        ...
                        <div class="col-md-12">
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                    ...
                                    <a type="button" href="{{ route('lelang.pengajuan.file.edit', [$lelang->lelang_id, $file->dokumen_produk_id]) }}" class="btn mx-2 btn-success"><i class="fas fa-pen"></i> Ubah</a>
                                    <form action="{{ route('lelang.pengajuan.file.destroy', [$lelang->lelang_id, $file->dokumen_produk_id]) }}" method="POST">@csrf @method('delete')
