            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('transaksi.lelang_baru.file.create', $lelang->lelang_id) }}" class="btn btn-primary">
                            Tambah
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <a href="{{ route('transaksi.lelang_baru.show', $lelang->lelang_id) }}" class="btn btn-primary">Kembali</a>
                </div>
            </div>
        </div>
    </div>
