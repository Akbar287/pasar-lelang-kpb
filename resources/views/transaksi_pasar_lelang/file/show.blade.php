                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                    <a type="button" href="{{ route('transaksi.lelang_baru.file', $lelang->lelang_id) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                                    <a type="button" href="{{ route('transaksi.lelang_baru.file.edit', [$lelang->lelang_id, $file->dokumen_produk_id]) }}" class="btn mx-2 btn-success"><i class="fas fa-pen"></i> Ubah</a>
                                    <form action="{{ route('transaksi.lelang_baru.file.destroy', [$lelang->lelang_id, $file->dokumen_produk_id]) }}" method="POST">@csrf @method('delete')
