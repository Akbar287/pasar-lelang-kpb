...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('transaksi.verifikasi_lelang.ditolak') }}">Verifikasi Ditolak</a></div>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        ...
                                        <form action="{{ route('transaksi.verifikasi_lelang.cancel.ditolak', $lelang->lelang_id) }}" method="POST">@csrf @method('put')
                                            <button type="submit" onclick="return confirm('Lelang akan diverifikasi Ulang!\n Lanjutkan?')" title="Verifikasi Ulang Data" class="btn btn-success"><i class="fas fa-undo"></i> Verifikasi Ulang</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
