                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row mb-3 justify-content-center jenis-penyelenggaraan {{ $lelang->status_lelang_pivot()->orderBy('created_at', 'desc')->first()->status_lelang()->first()->nama_status == 'Tolak' ? 'd-none' : ($lelang->status_lelang_pivot()->orderBy('created_at', 'desc')->first()->status_lelang()->first()->nama_status == 'Daftar' ? 'd-none' : '') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="selectgroup w-100">
                                                <label class="selectgroup-item">
                                                    <input type="radio" name="jenis_penyelenggaraan" value="online" class="selectgroup-input" {{ $lelang->status_lelang_pivot()->orderBy('created_at', 'desc')->first()->status_lelang()->first()->nama_status == 'Daftar' ? "" : "disabled" }} {{ $lelang->status_lelang_pivot()->orderBy('created_at', 'desc')->first()->status_lelang()->first()->nama_status == 'Tolak' ? '' : ($lelang->status_lelang_pivot()->orderBy('created_at', 'desc')->first()->status_lelang()->first()->nama_status == 'Daftar' ? (old('jenis_penyelenggaraan') == 'online' ? 'checked=""' : '') : ($lelang->jenis_platform_lelang()->first()->online && !$lelang->jenis_platform_lelang()->first()->offline ? 'checked=""' : "")) }}>
                                ...
                                <div class="row mb-3 justify-content-center sesi-offline {{ is_null($lelang->jenis_platform_lelang()->first()) ? 'd-none' : ($lelang->jenis_platform_lelang()->first()->offline ? '' : 'd-none') }}">
                                    <label for="event_lelang" class="col-md-4 col-form-label text-md-end">{{ __('Event')
                                        }}</label>
            
                                    <div class="col-md-6">
                                        @if(is_null($lelang->jenis_platform_lelang()->first()))
                                            @if(count($eventLelang) > 0)
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('transaksi.lelang_list') }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        <a type="button" href="{{ route('transaksi.lelang_list.file', $lelang->lelang_id) }}" class="btn mr-2 btn-info"><i class="fas fa-file"></i> Dokumen</a>
                                        <a type="button" href="{{ route('transaksi.lelang_list.edit', $lelang->lelang_id) }}" class="btn btn-success mr-2"><i class="fas fa-pen"></i> Ubah</a>
                                    </div>
                                </div>
                            </div>
                        </div>
