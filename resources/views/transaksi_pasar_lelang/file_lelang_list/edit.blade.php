...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('transaksi.lelang_list.file.show', [$lelang->lelang_id, $file->dokumen_produk_id]) }}">Detail</a></div>
...
<div class="section-body">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form action="{{ route('transaksi.lelang_list.file.update', [$lelang->lelang_id, $file->dokumen_produk_id]) }}" method="post" enctype="multipart/form-data">@csrf @method('put')
                <div class="card">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('transaksi.lelang_list.file.show', [$lelang->lelang_id, $file->dokumen_produk_id]) }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
