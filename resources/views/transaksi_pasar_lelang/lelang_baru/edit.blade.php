...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('transaksi.lelang_baru') }}">Lelang Baru</a></div>
...
<div class="section-body">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form action="{{ route('transaksi.lelang_baru.update', $lelang->lelang_id) }}" method="post" enctype="multipart/form-data">@csrf @method('put')
                <div class="card">
