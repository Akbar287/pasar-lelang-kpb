...
<div class="section-header">
    <h1>Detail Verifikasi Transaksi Lelang</h1>
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></div>
        <div class="breadcrumb-item"><a href="{{ route('operational') }}">Operational</a></div>
        <div class="breadcrumb-item"><a href="{{ route('operational.lelang.verifikasi.index') }}">Verifikasi Transaksi Lelang</a></div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>{{ __('Verifikasi Transaksi Lelang Ditolak') }}</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="kode_penyelesaian" type="text" readonly
                                        ...
                                        value="{{ $lelang->approval_lelang()->first()->pembayaran_lelang()->first()->nomor_penyelesaian }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <textarea name="keterangan" @if(!is_null($approval_lelang)) readonly @endif class="form-control " id="keterangan" id="" cols="30" rows="10">{{ !is_null($approval_lelang) ? $approval_lelang->pembayaran_lelang()->first()->keterangan : old('keterangan') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="nomor_instruksi_keuangan_masuk" type="text" @if(!is_null($approval_lelang)) readonly @endif
                                        class="form-control" name="nomor_instruksi_keuangan_masuk"
                                        value="{{ !is_null($approval_lelang) ? $approval_lelang->pembayaran_lelang()->first()->keuangan_masuk()->first()->no_instruksi : (is_null(old('nomor_instruksi_keuangan_masuk')) ? $instruksi['keuangan_masuk'] : old('nomor_instruksi_keuangan_masuk')) }}" />
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="nomor_faktur_keuangan_masuk" type="text" readonly
                                        ...
                                        value="{{ !is_null($approval_lelang) ? $approval_lelang->pembayaran_lelang()->first()->keuangan_masuk()->first()->no_faktur : $faktur['keuangan_masuk'] }}" />
                                </div>
                            </div>
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="tanggal_keuangan_masuk" type="text" readonly
                                        ...
                                        value="{{ !is_null($approval_lelang) ? $approval_lelang->pembayaran_lelang()->first()->keuangan_masuk()->first()->tanggal_instruksi : (is_null(old('tanggal_keuangan_masuk')) ? date('Y-m-d') : old('tanggal_keuangan_masuk')) }}" />
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="nomor_rekening_penyelenggara_keuangan_masuk" type="text" readonly
                                        ...
                                        value="{{ !is_null($approval_lelang) ? $approval_lelang->pembayaran_lelang()->first()->keuangan_masuk()->first()->rekening_bank()->first()->nama_pemilik . ' - ' . $approval_lelang->pembayaran_lelang()->first()->keuangan_masuk()->first()->rekening_bank()->first()->nomor_rekening . ' ('. $approval_lelang->pembayaran_lelang()->first()->keuangan_masuk()->first()->rekening_bank()->first()->mata_uang .' '. $approval_lelang->pembayaran_lelang()->first()->keuangan_masuk()->first()->rekening_bank()->first()->saldo .')' :'Tidak ada Nomor Rekening' }}" />
                                    @else
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="status_keuangan_masuk" type="text" readonly
                                        ...
                                        value="{{ !is_null($approval_lelang) ? $approval_lelang->pembayaran_lelang()->first()->keuangan_masuk()->first()->status : 'Belum Selesai' }}" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="nomor_instruksi_keuangan_keluar" type="text" @if(!is_null($approval_lelang)) readonly @endif
                                        ...
                                        value="{{!is_null($approval_lelang) ? $approval_lelang->pembayaran_lelang()->first()->keuangan_keluar()->first()->no_instruksi : (is_null(old('nomor_instruksi_keuangan_keluar')) ? $instruksi['keuangan_keluar'] : old('nomor_instruksi_keuangan_keluar')) }}" />
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="tanggal_keuangan_keluar" type="text" readonly
                                        ...
                                        value="{{ !is_null($approval_lelang) ? $approval_lelang->pembayaran_lelang()->first()->keuangan_keluar()->first()->tanggal_instruksi : (is_null(old('tanggal_keuangan_keluar')) ? date('Y-m-d') : old('tanggal_keuangan_keluar')) }}" />
            ...
            <div class="card">
                <div class="card-header">
                    <h4>{{ __('Status Verifikasi Komoditas') }}</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('lelang.transaksi.komoditas.keluar.update', [$lelang->lelang_id, $approval_lelang->pembayaran_lelang()->first()->komoditas_keluar()->first()->komoditas_keluar_id]) }}" method="POST">@csrf @method('put')
                                <div class="row mb-3 justify-content-center">
                                    <label for="status_komoditas_dikirim" class="col-md-4 col-form-label text-md-end">{{ __('Komoditas Sudah Dikirim Penjual')
                                        }}</label>

                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <select id="status_komoditas_dikirim" class="custom-select @error('status_komoditas_dikirim') is-invalid @enderror" name="status_komoditas_dikirim">
                                                <option {{ $approval_lelang->pembayaran_lelang()->first()->komoditas_keluar()->first()->status == 'Belum Selesai' ? 'selected' : '' }} value="{{ 'Belum Selesai' }}">Belum Selesai</option>
                                                <option {{ $approval_lelang->pembayaran_lelang()->first()->komoditas_keluar()->first()->status == 'Selesai' ? 'selected' : '' }} value="{{ 'Selesai' }}">Selesai</option>
                                            </select>

                                            <div class="input-group-append">
                                                <button type="submit" class="btn btn-success"><i class="fas fa fa-check"></i> Selesai</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form action="{{ route('lelang.transaksi.komoditas.masuk.update', [$lelang->lelang_id, $approval_lelang->pembayaran_lelang()->first()->komoditas_masuk()->first()->komoditas_masuk_id]) }}" method="POST">@csrf @method('put')
                                <div class="row mb-3 justify-content-center">
                                    <label for="status_komoditas_diterima" class="col-md-4 col-form-label text-md-end">{{ __('Komoditas Diterima Pembeli')
                                        }}</label>

                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <select id="status_komoditas_diterima" class="custom-select @error('status_komoditas_diterima') is-invalid @enderror" name="status_komoditas_diterima">
                                                <option {{ $approval_lelang->pembayaran_lelang()->first()->komoditas_masuk()->first()->status == 'Belum Selesai' ? 'selected' : '' }} value="{{ 'Belum Selesai' }}">Belum Selesai</option>
                                                <option {{ $approval_lelang->pembayaran_lelang()->first()->komoditas_masuk()->first()->status == 'Selesai' ? 'selected' : '' }} value="{{ 'Selesai' }}">Selesai</option>
                                            </select>
                                            <div class="input-group-append">
                                                <button type="submit" class="btn btn-success"><i class="fas fa fa-check"></i> Selesai</button>
                                            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4>{{ __('Status Verifikasi Keuangan') }}</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('lelang.transaksi.komoditas.keluar.update', [$lelang->lelang_id, $approval_lelang->pembayaran_lelang()->first()->komoditas_keluar()->first()->komoditas_keluar_id]) }}" method="POST">@csrf @method('put')
                                <div class="row mb-3 justify-content-center">
                                    <label for="status_komoditas_dikirim" class="col-md-4 col-form-label text-md-end">{{ __('Pembayaran Sudah di Kirim')
                                        }}</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="input-group-append">
                                                <button type="submit" class="btn btn-success"><i class="fas fa fa-check"></i> Kreditkan Akun</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form action="{{ route('lelang.transaksi.komoditas.masuk.update', [$lelang->lelang_id, $approval_lelang->pembayaran_lelang()->first()->komoditas_masuk()->first()->komoditas_masuk_id]) }}" method="POST">@csrf @method('put')
                                <div class="row mb-3 justify-content-center">
                                    <label for="status_komoditas_diterima" class="col-md-4 col-form-label text-md-end">{{ __('Pembayaran sudah diterima')
                                        }}</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="input-group-append">
                                                <button type="submit" class="btn btn-success"><i class="fas fa fa-check"></i> Kirim Ke Penjual</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <form action="{{ route('operational.lelang.verifikasi.confirmation', $lelang->lelang_id) }}" method="post"> @csrf @method('put')
                <div class="card">
                    <div class="card-header">
                        <h4>{{ __('Pilihan') }}</h4>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        @if(is_null($approval_lelang->pembayaran_lelang()->first()->verified_log()->first()))
                                        <select class="custom-select @error('confirmation') is-invalid @enderror" {{ !is_null($approval_lelang->pembayaran_lelang()->first()->verified_log()->first()) ? 'disabled' : '' }} name="confirmation" id="confirmation">
                                        ...
                                        <input id="confirmation" type="text" readonly
                                            ...
                                            value="{{ $approval_lelang->pembayaran_lelang()->first()->verified_log()->first()->is_agree ? 'Verifikasi Diterima' : 'Verifikasi Ditolak' }}" />
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="keterangan" {{ !is_null($approval_lelang->pembayaran_lelang()->first()->verified_log()->first()) ? 'disabled' : '' }} class="form-control  @error('keterangan') is-invalid @enderror" name="keterangan" type="text" cols="30" rows="10">{{ !is_null($approval_lelang->pembayaran_lelang()->first()->verified_log()->first()) ? $approval_lelang->pembayaran_lelang()->first()->verified_log()->first()->keterangan : '' }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('operational.lelang.verifikasi.index') }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        @if(is_null($lelang->approval_lelang()->first()->pembayaran_lelang()->first()->verified_log()->first()))
                                        <button type="submit" onclick="return confirm('Transaksi Lelang ini akan diverifikasi.. \nAnda Yakin ?')" href="{{ route('operational.lelang.verifikasi.confirmation', $lelang->lelang_id) }}" class="btn mx-2 btn-success"><i class="fas fa-pen"></i> Verifikasi</button>
                                        @endif
                                    </div>
                                </div>
                            </div>
