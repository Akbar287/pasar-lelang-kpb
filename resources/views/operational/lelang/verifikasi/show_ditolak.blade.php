...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('operational.lelang.verifikasi.index_ditolak') }}">Verifikasi Ditolak</a></div>
...
<div class="section-body">
    ...
    <p class="section-lead">
        Detail data Verifikasi Transaksi Lelang anda.
    </p>
                            ...
                            <div class="col-md-12">
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                        <a type="button" href="{{ route('operational.lelang.verifikasi.index_ditolak') }}" class="btn btn-primary mr-2"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        @if(!is_null($approval_lelang->pembayaran_lelang()->first()->verified_log()->first()))
                                        <form action="{{ route('operational.lelang.verifikasi.confirmation_ulang', $lelang->lelang_id) }}" method="post"> @csrf @method('put')
                                            <button type="submit" href="{{ route('administrasi.kas_bank.verifikasi.confirmation_ulang', $lelang->lelang_id) }}" class="btn mx-2 btn-success"><i class="fas fa-pen"></i> Verifikasi Ulang</button>
                                        </form>
                                        @endif
                                    </div>
                                </div>
